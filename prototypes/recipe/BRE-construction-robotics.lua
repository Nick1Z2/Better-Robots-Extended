...
data:extend({

	{
		...
		ingredients =
		{
		  {type = "item", name = "construction-robot", amount = scale},
	...
	},
	{
		...
		ingredients =
		{
		  {type = "item", name = "BRE-construction-robotics-mk2", amount = scale},
	...
	},
	{
		...
		ingredients =
		{
		  {type = "item", name = "BRE-construction-robotics-mk3", amount = scale},
	...
	},
	{
		...
		ingredients =
		{
		  {type = "item", name = "BRE-construction-robotics-mk4", amount = scale},
...
if settings.startup["BRE-erzwinge-MK1-Bots"].value then
    data:extend({
        {
            type = "recipe",
            name = "BRE-construction-robotics",
            enabled = false,
            allow_quality = true,
            ingredients = {
