...
{
    {
      ...
      ingredients =
      {
        ...
        {type = "item", name = "steel-chest", amount = cost(4)}
      },
      results = {
        {type = "item", name = "BRE-robo-box-mk1", amount = 1}
      }
    },
    {
      type = "recipe",
