...
local prerequisites_mk2 = {"BRE-robo-Erweiterung-mk1"}
local prerequisites_mk3 = {"BRE-robo-Erweiterung-mk2"}
...
if max_tier == "MK1" or max_tier == "MK2" or max_tier == "MK3" then
  table.insert(technologies, {
		...
		localised_description = { "technology-description.BRE-robo-Erweiterung-mk1" },
		icon = "__Better_Robots_Extended__/graphics/Forschung/bre-robo-erweiterung-mk1.png",
		icon_size = 256,
		effects =
		{
			{
				type = "unlock-recipe",
				recipe = "BRE-robo-erweiterung-mk1"
			}
		},
...
if max_tier == "MK2" or max_tier == "MK3" then
  table.insert(technologies, {
		...
		localised_description = { "technology-description.BRE-robo-Erweiterung-mk2" },
		icon = "__Better_Robots_Extended__/graphics/Forschung/bre-robo-erweiterung-mk2.png",
		icon_size = 256,
		effects =
		{
			{
				type = "unlock-recipe",
				recipe = "BRE-robo-erweiterung-mk2"
			}
		},
...
if max_tier == "MK3" then
  table.insert(technologies, {
		...
		localised_description = { "technology-description.BRE-robo-Erweiterung-mk3" },
		icon = "__Better_Robots_Extended__/graphics/Forschung/bre-robo-erweiterung-mk3.png",
		icon_size = 256,
		effects =
		{
			{
				type = "unlock-recipe",
				recipe = "BRE-robo-erweiterung-mk3"
			}
		},
