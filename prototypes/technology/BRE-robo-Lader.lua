...
local prerequisites_mk2 = {"BRE-robo-lader-mk1"}
local prerequisites_mk3 = {"BRE-robo-lader-mk2"}
...
if max_tier == "MK1" or max_tier == "MK2" or max_tier == "MK3" then
  table.insert(technologies, {
		...
		localised_description = { "technology-description.BRE-robo-lader-mk1" },
		icon = "__Better_Robots_Extended__/graphics/Forschung/bre-robo-lader-mk1.png",
		icon_size = 256,
		effects =
		{
			{
				type = "unlock-recipe",
				recipe = "BRE-robo-lader-mk1"
			}
		},
...
if max_tier == "MK2" or max_tier == "MK3" then
  table.insert(technologies, {
		...
		localised_description = { "technology-description.BRE-robo-lader-mk2" },
		icon = "__Better_Robots_Extended__/graphics/Forschung/bre-robo-lader-mk2.png",
		icon_size = 256,
		effects =
		{
			{
				type = "unlock-recipe",
				recipe = "BRE-robo-lader-mk2"
			}
		},
...
if max_tier == "MK3" then
  table.insert(technologies, {
		...
		localised_description = { "technology-description.BRE-robo-lader-mk3" },
		icon = "__Better_Robots_Extended__/graphics/Forschung/bre-robo-lader-mk3.png",
		icon_size = 256,
		effects =
		{
			{
				type = "unlock-recipe",
				recipe = "BRE-robo-lader-mk3"
			}
		},
