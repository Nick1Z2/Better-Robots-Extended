...
data:extend({
  {
    ...
    place_result = "BRE-robo-erweiterung-mk1",
    stack_size = 10,
    weight = 100*kg,
  },
  {
    ...
    icon = "__Better_Robots_Extended__/graphics/icons/bre-robo-erweiterung-mk2.png",
    icon_size = 64, icon_mipmaps = 4,
    subgroup = "logistic-network",
    order = "c[signal]-ae[roboport]",
    inventory_move_sound = item_sounds.roboport_inventory_move,
    pick_sound = item_sounds.roboport_inventory_pickup,
    drop_sound = item_sounds.roboport_inventory_move,
    place_result = "BRE-robo-erweiterung-mk2",
    stack_size = 10,
    weight = 100*kg,
  },
  {
    ...
    icon = "__Better_Robots_Extended__/graphics/icons/bre-robo-erweiterung-mk3.png",
    icon_size = 64, icon_mipmaps = 4,
    subgroup = "logistic-network",
    order = "c[signal]-af[roboport]",
    inventory_move_sound = item_sounds.roboport_inventory_move,
    pick_sound = item_sounds.roboport_inventory_pickup,
    drop_sound = item_sounds.roboport_inventory_move,
    place_result = "BRE-robo-erweiterung-mk3",
    stack_size = 10,
    weight = 100*kg,
  }
})
